package compare.stringtable;

public class CompareST {
    public static final String BUNDLE_NAME = "compare";
    
    /*************** EXTENSION POINTS ****************************************/
    
    //Matcher Extension Point
    public static final String MATCHER_SYMBOLIC_NAME ="compare.Matcher";
    public static final String MATCHER_EXTENSION = "matcher";
    
    public static final String COMPARISON_SYMBOLIC_NAME ="compare.Comparator";
